...
def num_overlaps(sites, predictedsites, motif_lengths, key, num):
    ...
    # if not os.path.exists('./evaluations_ver2/{}/overlaps'.format(str(num))):
    #     os.makedirs('./evaluations_ver2/{}/overlaps'.format(str(num)))
    # plt.savefig('./evaluations_ver2/{}/overlaps/{}_overlap.png'.format(str(num), key), bbox_inches='tight')
...
def read_predictedmotifs(num):
    ...
    predictedmotifs = {}
    for data_folder in dirs:
        with open('./outcomes2/{}/{}/predictedmotif.txt'.format(data_folder, str(num)), 'r') as f:
...
def evaluate_relative_entropy(motifs, predictedmotifs, num):
    ...
    plt.savefig('./evaluations_ver2/{}/relative_entropy_vs_icpc.png'.format(str(num)), bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/{}/relative_entropy_vs_ml.png'.format(str(num)), bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/{}/relative_entropy_vs_sc.png'.format(str(num)), bbox_inches='tight')
    plt.close('all')
    # for data_folder in dirs:
...
def evaluate_avg_relative_entropy(num):
    ...
    plt.savefig('./evaluations_ver2/avg_relative_entropy_vs_icpc.png', bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/avg_relative_entropy_vs_ml.png', bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/avg_relative_entropy_vs_sc.png', bbox_inches='tight')
    plt.close('all')
...
def evaluate_overlaps(sites, predictedsites, motif_lengths, num):
    ...
    plt.savefig('./evaluations_ver2/{}/overlaps_vs_icpc.png'.format(str(num)), bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/{}/overlaps_vs_ml.png'.format(str(num)), bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/{}/overlaps_vs_sc.png'.format(str(num)), bbox_inches='tight')
    plt.close('all')
...
def evaluate_avg_overlaps(num):
    ...
    plt.savefig('./evaluations_ver2/avg_overlaps_vs_icpc.png', bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/avg_overlaps_vs_ml.png', bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/avg_overlaps_vs_sc.png', bbox_inches='tight')
    plt.close('all')
...
def evaluate_runtime(runtime, num):
    ...
    plt.savefig('./evaluations_ver2/{}/runtime_vs_icpc.png'.format(str(num)), bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/{}/runtime_vs_ml.png'.format(str(num)), bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/{}/runtime_vs_sc.png'.format(str(num)), bbox_inches='tight')
    plt.close('all')
...
def evaluate_avg_runtime(num):
    ...
    plt.savefig('./evaluations_ver2/avg_runtime_vs_icpc.png', bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/avg_runtime_vs_ml.png', bbox_inches='tight')
    ...
    plt.savefig('./evaluations_ver2/avg_runtime_vs_sc.png', bbox_inches='tight')
    plt.close('all')


def main():

    if not os.path.exists('./evaluations_ver2'):
        os.makedirs('./evaluations_ver2')
    ...
    for num in range(trials):
        ...
        if not os.path.exists('./evaluations_ver2/{}'.format(str(num))):
            os.makedirs('./evaluations_ver2/{}'.format(str(num)))
    ...
    #############################################################################################
        ...
        for data_folder in dirs:
            with open('./outcomes2/{}/{}/predictedsites.txt'.format(data_folder, str(num)), 'r') as f:
    ...
    #############################################################################################
        ...
        for data_folder in dirs:
            with open('./outcomes2/{}/{}/runtime.txt'.format(data_folder, str(num)), 'r') as f:
